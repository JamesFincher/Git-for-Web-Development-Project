...
1. What is git? What is the difference between git and GitHub?
   Git is a version control system. GitHub is a repository that utilizes git to host your code.
2. Why do we create a branch?
   To make sure we are not messing with the main code.
3. What is the purpose of a pull request?
   A pull request allows others to review your changes, and to act as a go-between for your fork code, and the main branch.
4. What is the command you can use to switch between branches? For example you are working on a feature branch and you want to switch back to main.
   git checkout "BRANCH NAME"
5. Explain the difference between `git fetch`, `git merge` and `git pull` what does each command do?
   Git pull downloads and combines, merge combines code, and fetch downloads
6. What is a merge conflict? How do you resolve a merge conflict?
   Merge conflicts happen when you merge branches that have competing commits, and Git needs your help to decide which changes to incorporate in the final merge. To resolve a merge conflict, you can using the conflict editor if it's line collision, or by using a local clone, and pushing the changes individually.
